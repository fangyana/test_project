package com.f.pro.config.annotation.aop;

import com.f.pro.config.annotation.ParamCheck;
import com.f.pro.config.annotation.exception.ParamIsNullException;
...
public class ParamCheckAop {
     ...
     * 定义有一个切入点，范围为web包下的类
     */
    @Pointcut("execution(public * com.f.pro.controller..*.*(..))")
