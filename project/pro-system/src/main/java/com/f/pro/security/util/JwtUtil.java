...
public class JwtUtil {
     ...
     * 密钥
     */
    private static final String SECRET = "skyOrange";
    /**
     * 有效期1小时
     */
     ...
     * @return 令牌
     */
    public static String generateToken(ProSecurityUser userDetail) {
     ...
     * @return 用户名
     */
    public ProSecurityUser getUserFromToken(HttpServletRequest request) {
        // 获取请求携带的令牌
        ...
        if (StringUtils.isNotEmpty(token)) {
            ...
            if (validateToken(token, username)) {
                // 未把密码放到jwt
                return new ProSecurityUser(userId, username, "", deptId, authorities, null);
            }
        }
        return null;
    }
