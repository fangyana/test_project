    ...
    >
      ...
      <el-menu-item index="0" style="pointer-events: none;">
        ...
        <div v-if="isCollapse" class="logo-con" style="width: 100%;height: 100%;text-align: center; padding-top: 10px">
          <!-- <img src="@/assets/logo/logo.png" alt="pre系统logo" style="max-width: 70%;max-height: 70%"> -->
        </div>
        <!--正常状态下显示的，可以使用本地的logoImg-->
        <!-- <div class="logo-con" style="width: 100%;height: 100%;text-align: center; padding-top: 10px">
          <img src="@/assets/logo/logo.png" alt="消防系统logo" style="max-width: 100%;max-height: 100%">
          <span>消防管理系统</span>
        </div> -->
      </el-menu-item>
