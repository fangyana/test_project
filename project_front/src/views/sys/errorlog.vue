  ...
  <div class="wel-contailer">
    <el-row :gutter="20">
      ...
      <div class="wel-contailer-main">
        <el-table v-loading="loading" :data="tableData" style="width: 100%" :height="&quot;100%&quot;" size="mini">
          ...
          <el-table-column label="请求URL" width="200" align="center">
            <template slot-scope="scope">
          ...
          <el-table-column
            ...
            align="center"
          />
          <el-table-column label="请求时间(毫秒)" width="150" align="center">
            <template slot-scope="scope">
