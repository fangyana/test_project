<template>
  <div class="wel-contailer">
        ...
        <el-table-column label="操作" width="300" align="center">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              type="primary"
              size="mini"
              @click="handleChange(scope.row.name)"
            >字典值</el-button>
          </template>
        </el-table-column>
      </el-table>
        ...
        <el-table v-loading="loading" :data="dictDetailData" size="small" style="width: 100%;">
          ...
          <el-table-column label="操作" width="140px" align="center">
            <template slot-scope="scope">
              ...
              <el-popover :ref="scope.row.id" placement="top" width="120">
                <p>确定删除本条数据吗？</p>
                <div style="text-align: right; margin: 0">
    ...
    <el-dialog
      :append-to-body="true"
      :visible.sync="ddialog"
      :title="isValueAdd ? '新增字典详情' : '编辑字典详情'"
      width="500px"
    >
...
export default {
  data() {
    return {
      ...
      delLoading: false,
      rules: {
        name: [{ required: true, message: "字典名称不为空", trigger: "blur" }],
        description: [
          { required: true, message: "描述不为空", trigger: "blur" }
        ]
      },
      drules: {
        label: [{ required: true, message: "字典标签不为空", trigger: "blur" }],
        value: [{ required: true, message: "字典值不为空", trigger: "blur" }]
      },
      queryTypeOptions: [
